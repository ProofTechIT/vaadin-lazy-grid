module.exports = function ( grunt ) {
  ...
  var taskConfig = {
     ...
     * CoffeeScript is not the default in reports, so we're just using
     * the defaults here.
     */
    coffeelint: {
      src: {
  ...
  grunt.registerTask( 'build', [
    'clean', 
	//'html2js', 
	'jshint', 'coffeelint', 'coffee', 'less:build',
    'concat:build_css', 'copy:build_app_assets', 'copy:build_vendor_assets',
    'copy:build_appjs', 'copy:build_vendorjs', 'copy:build_vendorcss', 'copy:build_fonts', 'index:build'
