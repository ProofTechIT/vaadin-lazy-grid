...
public class TMTableCellProvider3 implements TableCellProvider, Serializable {
	...
	public TMTableCellProvider3() {
		this(new HashSet<String>());
	}

	public TMTableCellProvider3(Set<String> cellTypeSet) {
		super();
