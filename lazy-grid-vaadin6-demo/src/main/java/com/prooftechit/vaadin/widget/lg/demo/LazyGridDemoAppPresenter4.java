...
public class LazyGridDemoAppPresenter4 implements LazyGridDemoPresenter {

	private List<LgTableCell> selectedCellList;
	private TMTableCellProvider tableCellProvider = new TMTableCellProvider(
	...
	public LazyGridDemoAppPresenter4() {
	}
	...
	public TMTableCellProvider getTableCellProvider() {
	...
	private LgTableMeta createTableMetaTop(int c, int r) {
        ...
        for (int i = 14; i < r-2; i += 4) {
            LgTableCellRange subheaderRange = new LgTableCellRange();
            cellSpanList.add(subheaderRange);
            subheaderRange.setLeft(0);
            subheaderRange.setTop(i);
            subheaderRange.setRight(1);
            subheaderRange.setBottom(i);

            subheaderRange = new LgTableCellRange();
            cellSpanList.add(subheaderRange);
            subheaderRange.setLeft(0);
            subheaderRange.setTop(i+1);
            subheaderRange.setRight(1);
            subheaderRange.setBottom(i+1);
