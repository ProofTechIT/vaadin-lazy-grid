...
public class TMTableCellProvider4 implements TableCellProvider, Serializable {
	...
	public TMTableCellProvider4() {
		this(new HashSet<String>());
	}

	public TMTableCellProvider4(Set<String> cellTypeSet) {
		super();
	...
	private LgTableCell createTableCell(final int r, final int c) {
		...
		if (c == 0 && r == 0 || c == 1 && r == 1 || c == 0 && r == 2 || c == 0 && r == 1 || c == 1 && r == 0 || c == 1 && r == 2) {
