...
public class LazyGridDemoAppPresenter implements LazyGridDemoPresenter {
	...
	public LazyGridDemoAppPresenter() {
	}
	...
	private LgTableMeta createTableMetaTop(int c, int r) {
        ...
        customRange.setLeft(4);
        customRange.setTop(2);
        customRange.setRight(5);
        customRange.setBottom(3);
